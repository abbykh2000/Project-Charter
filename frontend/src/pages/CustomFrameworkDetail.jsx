        ...
        >
          <div style={syncSourceStyle}>
            ...
            <div>
              ...
              <p style={syncDescriptionStyle}>
                Control definitions are imported from the configured worksheet while dashboard-managed fields remain editable.
              </p>
            </div>
          </div>
          ...
          <div style={syncDetailsStyle}>
            ...
            <div style={syncDetailStyle}>
              ...
              <strong
                style={syncValueStyle}
                title={`${columnMapping.requirementNumber}, ${columnMapping.category}, ${columnMapping.question}`}
              >
                {columnMapping.requirementNumber} · {columnMapping.category} · {columnMapping.question}
              </strong>
            </div>
      ...
      <section style={noticeCardStyle}>
        ...
        <div>
          ...
          <p style={noticeTextStyle}>
            This framework is managed separately from Secureframe. Control definitions may come from Google Sheets, while owners, statuses, evidence URLs, and comments remain managed through the dashboard.
          </p>
        </div>
      </section>
    </PageLayout>
